...
export default function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (handleValidation()) {
      ...
      try {
        console.log('Submitting registration to:', registerRoute);
        ...
        if (error.response) {
          ...
          toast.error("No response from server. Please try again later.", toastOptions);
          console.error("No response received:", error.request);
        } else {
          // Something happened in setting up the request that triggered an Error
          toast.error("Error setting up request. Please try again.", toastOptions);
